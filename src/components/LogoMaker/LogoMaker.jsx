...
const LogoMaker = () => {
  return (
    <div className="logoMaker">
      <div className="logoMaker_content">
        <div className="logoMaker_logo">
          <svg
            width="249"
            height="34"
            viewBox="0 0 249 34"
        ...
        <h2 className="logoMaker_title">
          Make an incredible <br />
          logo <span>in seconds</span>
        </h2>
        <p className="logoMaker_message">
          Pre-designed by top talent. Just add your touch.
        </p>
        <div>
          <button className="logoMaker_button">Try Fiverr Logo Maker</button>
        </div>
      </div>
